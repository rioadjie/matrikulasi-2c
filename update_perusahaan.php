            ...
            <div id="content">
                ...
                <div class="content">
                    <div class="card card-info card-outline">
                        ...
                        <div class="card-body">
                            <form method="POST" action="proses_update_perusahaan.php">
                                <input type="hidden" name="Id" value="<?php echo $d['Id'];?>">
                                <div class="form-group">
                                    <input type="text" value="<?php echo $d['Nama_Perusahaan'];?>" id="Nama_Perusahaan" name="Nama_Perusahaan" class="form-control" placeholder="Nama Perusahaan">
                                </div>
                                <div class="form-group">
                                    <textarea name="Alamat" id="Alamat" class="form-control" placeholder="Alamat"><?php echo $d['Alamat'];?></textarea>
                                </div>
                                <div class="form-group">
                                    <input type="text" value="<?php echo $d['Email'];?>" id="Email" name="Email" class="form-control" placeholder="Email Perusahaan">
                                </div>
                                <div class="form-group">
                                    <input type="text" value="<?php echo $d['Telephone'];?>" id="Telephone" name="Telephone" class="form-control" placeholder="Telephone Perusahaan">
                                </div>
                                <div class="form-group">
