            ...
            <div id="content">
                ...
                <div class="content">
                    <div class="card card-info card-outline">
                        ...
                        <div class="card-body">
                            <form method="POST" action="tdosen.php">
                                <div class="form-group">
                                    <input type="text" id="Nama_dosen" name="Nama_dosen" class="form-control" placeholder="Nama Lengkap">
                                </div>
                                <div class="form-group">
                                    <input type="text" id="Nik" name="Nik" class="form-control" placeholder="NIK/NIP">
                                </div>
                                <div class="form-group">
