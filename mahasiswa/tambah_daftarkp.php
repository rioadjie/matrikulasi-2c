            ...
            <div id="content">
                ...
                <div class="content">
                    <div class="card card-info card-outline">
                        ...
                        <div class="card-body">
                            <form method="POST" action="tdaftarkp.php" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="">Tempat KP</label>
                                    <input type="text" id="Tempatkp" name="Tempatkp" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="">Alamat KP</label>
                                    <textarea name="Alamatkp" id="Alamatkp" class="form-control"></textarea>
                                </div>
                                <div class="form-group">
