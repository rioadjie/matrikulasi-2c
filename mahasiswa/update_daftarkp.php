...
$id = $_GET['id'];
$data = mysqli_query($koneksi, "SELECT * FROM pendaftaran_kp where id='$id'");
                ...
                <div class="container-fluid">
                    <div class="card card-info card-outline">
                        <div class="card-header">
                            <h3>Form Pendaftaran KP</h3>
                        </div>          

                        <div class="card-body">
                            <form method="POST" action="proses_update_daftarkp.php" enctype="multipart/form-data">
                                <input type="hidden" name="Id" value="<?php echo $d['Id'];?>">
                                <div class="form-group">
                                    <label for="">Tempat KP</label>
                                    <input type="text" id="Tempatkp" name="Tempatkp" class="form-control" value="<?php echo $d['Tempatkp'];?>">
                                </div>
                                <div class="form-group">
                                    <label for="">Alamat KP</label>
                                    <textarea name="Alamatkp" id="Alamatkp" class="form-control"><?php echo $d['Alamatkp'];?></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="">Tanggal Mulai</label>
                                    <input type="datetime-local" id="Tanggal_mulai" name="Tanggal_mulai" class="form-control" value="<?php echo $d['Tanggal_mulai'];?>">
                                </div> 
                                <div class="form-group">
                                    <label for="">Tanggal Selesai</label>
                                    <input type="datetime-local" id="Tanggal_selesai" name="Tanggal_selesai" class="form-control" value="<?php echo $d['Tanggal_selesai'];?>">
                                </div> 
                                <div class="form-group mb-3">
                                Upload Proposal (*Hanya menerima file PDF)
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select" arial-label="Anggota_Kelompok_Id" name="Anggota_Kelompok_Id">
                                        <option selected>Pilih Anggota Kelompok</option>
                                        <?php
                                        $sql=mysqli_query($koneksi, "SELECT * FROM anggota_kelompok");
                                        while ($data=mysqli_fetch_array($sql)) { 
                                        ?>
                                        <option value="<?=$data['Id']?>"><?=$data['Nim']?> - <?=$data['Nama_Anggota']?></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select" arial-label="Dosen_id" name="Dosen_id">
                                        <option selected>Pilih Dosbing</option>
                                        <?php
                                        $sql=mysqli_query($koneksi, "SELECT * FROM dosen");
                                        while ($data=mysqli_fetch_array($sql)) { 
                                        ?>
                                        <option value="<?=$data['id']?>"><?=$data['Nik']?> - <?=$data['Nama_dosen']?></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select" arial-label="Perusahaan_Id" name="Perusahaan_Id">
