...
$query    =mysqli_query($koneksi, "SELECT * FROM nilai WHERE Id='1'");
                            ...
                            <div class="table-responsive">
                                <table class="table" id="dataTable" width="100%" cellspacing="0">
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td><?php echo $data['Nilai_pembimbing_lapangan']; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Nilai Pembimbing KP</td>
                                        <td>:</td>
                                        <td><?php echo $data['Nilai_pembimbing_KP']; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Nilai Penguji</td>
                                        <td>:</td>
                                        <td><?php echo $data['Nilai_penguji']; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Bukti Nilai Pembimbing Lapangan</td>
                                        <td>:</td>
                                        <td><?php echo $data['Bukti_nilai_pembimbing_lapangan']; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Pendaftaran Ujian KP ID</td>
                                        <td>:</td>
                                        <td><?php echo $data['Pendaftaran_ujian_KP_Id']; ?></td>
                                    </tr>
                                    <br>
                                </table>
                                <button type="submit" class="btn btn-info">Download Nilai</button>
                            </div>
                        </div>
                    </div>
