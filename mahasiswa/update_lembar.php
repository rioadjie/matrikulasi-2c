...
$id = $_GET['id'];
$data = mysqli_query($koneksi, "SELECT * FROM lembar_kerja where id='$id'");
                ...
                <div class="content">
                    <div class="card card-info card-outline">
                        <div class="card-header">
                            <h3>Form Lembar Kerja KP</h3>
                        </div>          

                        <div class="card-body">
                            <form method="POST" action="proses_update_lembar.php" enctype="multipart/form-data">
                                <input type="hidden" name="Id" value="<?php echo $d['Id'];?>">
                                <div class="form-group mb-3">
                                    <label for="">Tanggal</label>
                                    <input type="datetime-local" id="Tanggal" name="Tanggal" class="form-control" value="<?php echo $d['Tanggal'];?>">
                                </div> 
                                <br>
                                <div class="form-group mb-3">
                                Upload File Aktiftas 
                                    <input type="file" name="File" id="File" class="form-control">
                                    <img src="lembarKerja/<?php echo $d['File'];?>" style="max-height:100px;max-width:100px;margin-top:10px;">
                                </div>
                                <br>
                                <?php } ?>
                                <div>
                                    <label for="">ID Anggota Kelompok : </label>
                                    <select class="form-select" arial-label="Anggota_Kelompok_Id" name="Anggota_Kelompok_Id">
                                        ...
                                        ?>
                                        <option value="<?=$data['Id']?>"><?=$data['Id']?> - <?=$data['Nama_Anggota']?></option>
