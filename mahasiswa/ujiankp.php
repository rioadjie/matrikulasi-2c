...
$query    =mysqli_query($koneksi, "SELECT pendaftaran_ujian_kp.Laporan_KP, pendaftaran_ujian_kp.Jadwal_ujian, acc_ujian.Dosen_Penguji, acc_ujian.ACC_ujiancol FROM pendaftaran_ujian_kp INNER JOIN acc_ujian ON pendaftaran_ujian_kp.ACC_ujian_Id = acc_ujian.Id WHERE pendaftaran_ujian_kp.Id = 1");
                            ...
                            <div class="table-responsive">
                                <table class="table" id="dataTable" width="100%" cellspacing="0">
                                    <tr>
                                        <td>Laporan KP</td>
                                        <td>:</td>
                                        <td><?php echo $data['Laporan_KP']; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Jadwal Ujian KP</td>
                                        <td>:</td>
                                        <td><?php echo $data['Jadwal_ujian']; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Dosen Penguji</td>
                                        <td>:</td>
                                        <td><?php echo $data['Dosen_Penguji']; ?></td>
                                    </tr>
                                    <tr>
                                        <td>ACC Ujian</td>
                                        <td>:</td>
                                        <td><?php echo $data['ACC_ujiancol']; ?></td>
                                    </tr>
                                    <br>
                                </table>
                            </div>
