                ...
                <div class="content">
                    <div class="card card-info card-outline">
                        <div class="card-header">
                            <h3>Form Daftar Ujian KP</h3>
                        </div>          

                        <div class="card-body">
                            <form method="POST" action="tdaftarujiankp.php" enctype="multipart/form-data">
                            <div class="form-group mb-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="datetime-local" id="Jadwal_ujian" name="Jadwal_ujian" class="form-control">
                                </div>
                                <div class="form-group">
