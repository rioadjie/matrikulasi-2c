...
$id = $_GET['id'];
$data = mysqli_query($koneksi, "SELECT * FROM anggota_kelompok where id='$id'");
            ...
            <div id="content">
                ...
                <div class="content">
                    <div class="card card-info card-outline">
                        ...
                        <div class="card-body">
                            <form method="POST" action="proses_update_anggota.php">
                                <input type="hidden" name="Id" value="<?php echo $d['Id'];?>">
                                <div class="form-group">
                                    <input type="text" value="<?php echo $d['Nama_Anggota'];?>" id="Nama_Anggota" name="Nama_Anggota" class="form-control" placeholder="Nama Anggota">
                                </div>
                                <div class="form-group">
