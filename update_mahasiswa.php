                        ...
                        <div class="card-body">
                            <form method="POST" action="proses_update_mhs.php">
                                ...
                                <div class="form-group">
                                    <input type="text" value="<?php echo $d['Nama_mahasiswa'];?>" id="Nama_mahasiswa" name="Nama_mahasiswa"   class="form-control" placeholder="Nama Lengkap">
                                </div>
                                <div class="form-group">
                                    <input type="text" value="<?php echo $d['Nim'];?>" id="Nim" name="Nim" class="form-control" placeholder="NIM">
                                </div>
                                <div class="form-group">
                                    <input type="text" value="<?php echo $d['Kelas'];?>" id="Kelas" name="Kelas" class="form-control" placeholder="Kelas">
                                </div>
                                <div class="form-group">
                                    <input type="text" value="<?php echo $d['Email'];?>" id="Email" name="Email" class="form-control" placeholder="Email">
                                </div>
                                <div class="form-group">
