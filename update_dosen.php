            ...
            <div id="content">
                ...
                <div class="content">
                    <div class="card card-info card-outline">
                        ...
                        <div class="card-body">
                            <form method="POST" action="proses_update_dsn.php">
                                <input type="hidden" name="id" value="<?php echo $d['id'];?>">
                                <div class="form-group">
                                    <input type="text" value="<?php echo $d['Nama_dosen'];?>" id="Nama_dosen" name="Nama_dosen"   class="form-control" placeholder="Nama Lengkap">
                                </div>
                                <div class="form-group">
                                    <input type="text" value="<?php echo $d['Nik'];?>" id="Nik" name="Nik" class="form-control" placeholder="NIM">
                                </div>
                                <div class="form-group">
