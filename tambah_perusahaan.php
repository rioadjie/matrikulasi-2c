            ...
            <div id="content">
                ...
                <div class="content">
                    <div class="card card-info card-outline">
                        ...
                        <div class="card-body">
                            <form method="POST" action="tperusahaan.php">
                                <div class="form-group">
                                    <input type="text" id="Nama_Perusahaan" name="Nama_Perusahaan" class="form-control" placeholder="Nama Perusahaan">
                                </div>
                                <div class="form-group">
                                    <textarea name="Alamat" id="Alamat" class="form-control" placeholder="Alamat Perusahaan"></textarea>
                                </div>
                                <div class="form-group">
                                    <input type="text" id="Email" name="Email" class="form-control" placeholder="Email Perusahaan">
                                </div>
                                <div class="form-group">
                                    <input type="text" id="Telephone" name="Telephone" class="form-control" placeholder="Telephone Perusahaan">
                                </div>
